...
import { Vote, TrendingUp, ArrowLeft, Share2 } from "lucide-react";
...
const Chairperson = () => {
  ...
  const nominees = [
    { name: "Dr. Ahmed Hassan", id: "chairperson-ahmed", bio: "Islamic Finance & Development expert with 20+ years of experience in humanitarian work and community development.", baseVotes: 687, dailyIncrease: 15 },
    { name: "Dr. Layla Mohamed", id: "chairperson-layla", bio: "Educational Programs specialist dedicated to advancing Islamic education and youth empowerment across communities.", baseVotes: 542, dailyIncrease: 12 },
    { name: "Dr. Tariq Rahman", id: "chairperson-tariq", bio: "Sustainability & Environment advocate focused on building eco-friendly mosques and promoting environmental stewardship.", baseVotes: 478, dailyIncrease: 9 }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="text-center">
              <h1 className="text-5xl md:text-6xl font-bold mb-6">Chairperson Election</h1>
              <p className="text-xl leading-relaxed opacity-90">
                Vote for the leader who will guide the 1000 Masjid Project
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="bg-muted">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-3">About the Chairperson Role</h3>
                <p className="text-muted-foreground">
                  The Chairperson leads committee meetings, represents the project at major events, 
                  and guides the strategic direction of the 1000 Masjid Project. This role requires 
                  strong leadership, vision, and commitment to Islamic values and humanitarian work.
                </p>
              </CardContent>
            </Card>
          </div>
